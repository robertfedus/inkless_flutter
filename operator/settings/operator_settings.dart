...
class OperatorSettings extends StatefulWidget {
  @override
  _OperatorSettingsState createState() => _OperatorSettingsState();
}
...
class _OperatorSettingsState extends State<OperatorSettings> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: Drawer(child: OperatorDrawer(colored: 'setari')),
      key: _scaffoldKey,
      appBar: AppBar(
        leading: IconButton(
          ...
          child: MainButton(
            ...
            click: () {
              Navigator.of(context)
                  .pushNamed('/operator_account_settings', arguments: '');
            },
          ),
        ),
        Padding(
