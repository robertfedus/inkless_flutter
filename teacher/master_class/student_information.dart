...
class MasterStudentInformation extends StatefulWidget {
  final String userPublicId, subjectPublicId;

  MasterStudentInformation({this.userPublicId, this.subjectPublicId});
  @override
  _MasterStudentInformationState createState() =>
      _MasterStudentInformationState();
}

class _MasterStudentInformationState extends State<MasterStudentInformation> {
  List<Map> _marks;
  List<Map> _marks2;
