...
class TeacherClassStudentsList extends StatefulWidget {
  final String classLetter, classGrade, publicId, subjectPublicId;

  TeacherClassStudentsList(
      {this.classLetter, this.classGrade, this.publicId, this.subjectPublicId});
  @override
  _TeacherClassStudentsListState createState() =>
      _TeacherClassStudentsListState();
}

class _TeacherClassStudentsListState extends State<TeacherClassStudentsList> {
  List<Map> _students;
