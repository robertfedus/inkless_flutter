...
class CollapseButton extends StatefulWidget {
  ...
  final String text, color, splashColor, destination, messagePublicId;
          ...
          children: <Widget>[
            SizedBox(
              ...
              child: FlatButton(
                ...
                child: QuicksandText(
                  text: widget.text.length > 32
                      ? widget.text.substring(0, 28) + '...'
                      : widget.text,
